...
public class CollectingPointUsersListAdapter extends BaseAdapter {

    Context contex;
    ArrayList<User> usersList;
    private String pic_path;

    public CollectingPointUsersListAdapter(Context c, ArrayList<User> usersList, String pic_path)
    {
        this.contex = c;
